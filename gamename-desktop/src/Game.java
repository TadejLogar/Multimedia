...
public class Game implements ApplicationListener {
        ...
        public void create() {
    		...
    		if (mesh == null) {
    			...
    			for (int i = 0; i < 6; i++) {
    				...
    				// statièno, maksimalno vertikal, maksimalno indeksov, atributi
    				...
    				mesh[i].setIndices(new short[] { 0, 1, 2, 3 }); // povezava oglišè
        ...
        public void render() {
    		...
    		Gdx.gl.glClear(GL10.GL_COLOR_BUFFER_BIT | GL10.GL_DEPTH_BUFFER_BIT); // poèistimo sceno
